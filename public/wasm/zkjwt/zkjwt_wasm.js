 ...
 * @returns {string}
 */
export function encode_auth_payload(secret, action, issuer, proof_b64) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        const ret = wasm.encode_auth_payload(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        deferred5_0 = ret[0];
        deferred5_1 = ret[1];
 ...
 * @returns {Uint8Array}
 */
export function encode_instances(secret, action) {
    const ptr0 = passStringToWasm0(secret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(action, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.encode_instances(ptr0, len0, ptr1, len1);
 ...
 * @returns {string}
 */
export function encode_register_claim(secret, issuer) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(secret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.encode_register_claim(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function generate_proof(secret, action) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(secret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('zkjwt_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
